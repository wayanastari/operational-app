        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-semibold text-gray-900">Cleopatra</span>
                </div>
            </div>
            ...
            <div class="flex items-center space-x-6">
                <div class="hidden md:flex items-center space-x-6">
                    ...
                    <div class="relative group">
                        <button class="text-gray-600 hover:text-gray-900 font-medium flex items-center space-x-1">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=32&h=32&fit=crop&crop=face" alt="User" class="w-8 h-8 rounded-full">
                        <span class="text-sm font-medium text-gray-700">MacLeod</span>
